const CACHE='elders-veil-v3';
const BASE=new URL('./',self.location.href);
const CORE=['index.html','comics.html','css/global.css','css/theme.css','js/api.js','js/auth.js','js/i18n.js','js/components.js'].map(x=>new URL(x,BASE).toString());
